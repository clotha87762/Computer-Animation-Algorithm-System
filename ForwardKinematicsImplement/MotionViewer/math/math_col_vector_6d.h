...
public:
    ...
    Vector3d_t AngularVector() const;
    Vector3d_t LinearVector() const;

    void SetAngularVector(const Vector3d_t &angular_vector);
    void SetLinearVector(const Vector3d_t &linear_vector);
...
template<typename Scalar>
typename ColVector6d<Scalar>::Vector3d_t ColVector6d<Scalar>::AngularVector() const
{
    return access::AngularVector(*this);
}

template<typename Scalar>
typename ColVector6d<Scalar>::Vector3d_t ColVector6d<Scalar>::LinearVector() const
{
    return access::LinearVector(*this);
}

template<typename Scalar>
void ColVector6d<Scalar>::SetAngularVector(const Vector3d_t &angular_vector)
{
...
template<typename Scalar>
void ColVector6d<Scalar>::SetLinearVector(const Vector3d_t &linear_vector)
{
