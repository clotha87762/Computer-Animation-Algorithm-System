...
std::basic_ostream<charT, traits> &operator<<(
        std::basic_ostream<charT, traits> &a_kOstream,
        const Transform<Scalar, 3, Isometry> &a_kIsometry3D
        );
...
{
    static constexpr char s_cNEWLINE = '\n';
    a_kOstream << "linear" << s_cNEWLINE
        << a_kIsometry3D.linear() << s_cNEWLINE
        << "translation: "
        << a_kIsometry3D.translation().transpose();
