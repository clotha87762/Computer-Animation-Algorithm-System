...
Camera::Camera()
    ...
    translation_(new Vector3d_t),
    look_at_pos_(new Vector3d_t)
{
}
...
Camera::Camera(const Camera &other)
    ...
    translation_(new Vector3d_t(other.translation())),
    look_at_pos_(new Vector3d_t(other.look_at_pos()))
{
}
...
Vector3d_t Camera::translation() const
{
    return *translation_;
}

Vector3d_t Camera::look_at_pos() const
{
    return *look_at_pos_;
}
...
void Camera::set_translation(const Vector3d_t &translation)
{
    *translation_ = translation;
}

void Camera::set_look_at_pos(const Vector3d_t &look_at_pos)
{
...
void Camera::ShiftTranslation(const Vector3d_t &shift_translation)
{
    *translation_ += shift_translation;
}

void Camera::ShiftLookAt(const Vector3d_t &shift_pos)
{
