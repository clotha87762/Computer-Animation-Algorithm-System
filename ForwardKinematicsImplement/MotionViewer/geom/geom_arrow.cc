...
Arrow::Arrow(const Vector3d_t &start_pos, const Vector3d_t &end_pos)
...
Vector3d_t Arrow::start_pos() const
{
    return *start_pos_;
}

Vector3d_t Arrow::end_pos() const
{
    return *end_pos_;
}
...
void Arrow::set_start_pos(const Vector3d_t &start_pos)
{
    *start_pos_ = start_pos;
}

void Arrow::set_end_pos(const Vector3d_t &end_pos)
{
    *end_pos_ = end_pos;
}
